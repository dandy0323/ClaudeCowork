...
ENTRIES = [
    ...
    # --- 第3週(4月) 2026/04/26 ---
    {
        ...
        "total_pl": -14946,
        "cash": 0,
        "trend_memo": "日経4/16最高値後に調整。ソニー・任天堂メモリコスト懸念で急落。三菱重工は停戦協議暗礁で+7,192円回復",
        "portfolio": [
            ("290A",  "Synspective",             100,    1330, "保有継続", "△", "宇宙・防衛テーマ継続",                        "停戦協議動向確認"),
            ("4661",  "オリエンタルランド",    17.88,   2401, "様子見",   "×", "4/28決算前の警戒売りで-14.16%まで悪化",        "4/28決算のガイダンス確認後に判断"),
            ("6146",  "ディスコ",              0.414,  71693, "保有継続", "△", "半導体需要回復期待は継続",                     "決算ガイダンス確認"),
            ("6758",  "ソニーグループ",            50,   3208, "様子見",   "×", "メモリ高騰でゲーム事業採算悪化懸念。9,350円急落", "決算でメモリコスト影響の開示を確認"),
            ("6857",  "アドバンテスト",         1.89,  29492, "保有継続", "○", "AI需要継続で+11.48%。好調維持",               "決算ガイダンス確認"),
            ("6954",  "ファナック",             7.23,   6259, "様子見",   "△", "中国需要回復待ち",                            "中国景況感指標確認"),
            ("7011",  "三菱重工業",            19.59,   4738, "保有継続", "○", "イラン停戦暗礁で防衛株V字回復+7,192円",        "停戦協議の行方を継続監視"),
            ("7735",  "SCREENホールディングス", 1.33,  21378, "保有継続", "△", "半導体装置、小幅回復",                         "受注動向確認"),
            ("7974",  "任天堂",                11.73,   7955, "様子見",   "×", "メモリコスト問題で再び-6.67%。含み損再拡大",    "決算でSwitch2採算性の開示を確認"),
